...
ui.model.Label = function(text,term) {
	...
	if(term == null) {
		...
		var textTermAtom = textTermParts[0].name;
		...
		var colorTermAtom = colorTermParts[0].name;
		var imageTerm = displayTermParts[1];
		var imageTermParts = imageTerm.partlist.list;
		var imageTermAtom = imageTermParts[0].name;
