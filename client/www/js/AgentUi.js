...
var defineWidget = function() {
	return { _create : function() {
		...
		var labelTA = new $("<textarea class='boxsizingBorder container' style='resize: none;'></textarea>").appendTo(labelInput).attr("id","labelInput_ta").attr("disabled","disabled");
		var tabs = new $("<aside class='tabs'></aside>").appendTo(section);
		...
		var labelTab = new $("<span class='ui-icon ui-icon-blank ui-corner-left'><img src='media/postlabel-icon.png'></span>").appendTo(tabs).click(function(evt) {
			tabs.children(".active").removeClass("active");
			$(this).addClass("active");
			textInput.hide();
			urlComp.hide();
