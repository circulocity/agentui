...
var defineWidget = function() {
	return { _create : function() {
		...
		var btcLabeledInput = new $("<label><input type='checkbox' id='btcCheck'>Create BTC Wallet?</label>").appendTo(btcCheckBoxCell);
		self.btcWalletChk = new $("#btcCheck");
